...
Usage of google_auth_proxy:
  ...
  -http-address="127.0.0.1:4180": <addr>:<port> to listen on for HTTP clients (equivalent to -listen http://<addr>:<port>)
  -listen="": <schema>://<addr>:<port> to listen on for HTTP clients, where schema is one of: "http", "tcp", "tcp4", "tcp6", "unix" or "unixpacket"
